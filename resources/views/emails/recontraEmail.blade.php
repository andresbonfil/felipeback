...
<h1>Estamos recuperando tu contraseña...</h1>
    ...
    padding:12px; border-radius:4px; text-decoration: none;" target="_blank">
    Restablecer mi contraseña</a></p>
    <a href="https://sistemapedidosback.herokuapp.com/emailRecovery?email={{$datos['email']}} " target="_blank">https://sistemapedidosback.herokuapp.com/emailRecovery?email={{$datos['email']}}</a>
